...
public static class WebApplicationBuilderExtensions
{
    ...
    public static WebApplicationBuilder ConfigureAuthN(this WebApplicationBuilder builder, OrdersServiceConfiguration cfg)
    {
    ...
    public static WebApplicationBuilder ConfigureAuthZ(this WebApplicationBuilder builder, OrdersServiceConfiguration cfg)
    {
