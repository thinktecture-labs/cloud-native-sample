...
locals {
  loki_endpoint = "http://${helm_release.grafana_loki.name}-loki-distributed-distributor.${helm_release.grafana_loki.namespace}.svc.cluster.local:3100/loki/api/v1/push"
}
