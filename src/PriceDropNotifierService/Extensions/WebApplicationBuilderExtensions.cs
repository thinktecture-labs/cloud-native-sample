...
{
    private static string serviceName = "PriceDropNotifierService";
    ...
    public static WebApplicationBuilder ConfigureLogging(this WebApplicationBuilder builder, PriceDropNotifierServiceConfiguration cfg)
    {
    ...
    public static WebApplicationBuilder ConfigureTracing(this WebApplicationBuilder builder, PriceDropNotifierServiceConfiguration cfg)
    {
        builder.Services
            .AddOpenTelemetry()
    ...
    public static WebApplicationBuilder ConfigureMetrics(this WebApplicationBuilder builder, PriceDropNotifierServiceConfiguration cfg)
    {
        builder.Services
            .AddOpenTelemetry()
            .ConfigureResource(ConfigureOpenTelemetryResource)
    ...
    public static WebApplicationBuilder ConfigureAuthN(this WebApplicationBuilder builder, PriceDropNotifierServiceConfiguration cfg)
    {
    ...
    public static WebApplicationBuilder ConfigureAuthZ(this WebApplicationBuilder builder, PriceDropNotifierServiceConfiguration cfg)
    {
